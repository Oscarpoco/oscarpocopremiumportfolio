...
const CornerBorders = ({ color = T.blue, size = 20, thickness = 2, opacity = 1 }) => (
  <>
    {/* Top Left */}
    <div style={{
    ...
    <CornerBorders />
      {navSections.map((section) => (
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          style={{
            background: activeSection === section.id ? 'transparent' : 'transparent',
...
const BigTitle = ({ children, size = 'clamp(64px, 13vw, 148px)' }) => (
  ...
  >
    <span style={{
      ...
      width: 40, height: 40, border: `2px solid ${T.blue}`,
...
const IconBtn = ({ href, icon, label, light = false }) => (
  <motion.a
    ...
    style={{
      ...
      fontSize: 17, textDecoration: 'none', transition: 'all 0.3s ease', flexShrink: 0,
    }}
  >
    {icon}
  </motion.a>
    ...
    <div style={{
      ...
      <AnimatedSection
        ...
        style={{
          ...
          justifyContent: 'center', padding: '120px 56px 64px',
      ...
      >
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', width: '100%', position: 'relative', zIndex: 1 }}>
          <EyebrowLabel>Intermediate Software Developer | Facilitator · Johannesburg, South Africa</EyebrowLabel>
          ...
          >
            <div>
              <p style={{ 
                fontFamily: T.mono, fontSize: 10, letterSpacing: '0.25em', 
                textTransform: 'uppercase', color: T.blue, marginBottom: 8, fontWeight: 600 
              }}>
                $ fullName
              </p>
              <h2 style={{ 
                fontFamily: T.body, fontSize: 'clamp(26px, 4vw, 50px)', 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 72px', alignItems: 'start' }}>
            <motion.div variants={fadeUp}>
              <p style={{ fontSize: 18, lineHeight: 1.85, color: '#333', marginBottom: 24, fontWeight: 500 }}>
                I'm a self-driven Software Developer and UI/UX designer from Johannesburg, passionate about building digital products that look good <em style={{ color: T.blue, fontStyle: 'normal' }}>and</em> work beautifully. I turn complex problems into clean, accessible interfaces.
              </p>
              <p style={{ fontSize: 18, lineHeight: 1.85, color: '#333', fontWeight: 500 }}>
                Currently sharpening my skills at World Wide Industrial Systems & Engineers as a Skills Facilitator (SDP) and Software Developer while studying Accounting Science at UNISA — because I believe great developers understand both code <em style={{ color: T.blue, fontStyle: 'normal' }}>and</em> business.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
              <div style={{ 
                ...
                <CornerBorders />
                <p style={{ 
                  fontFamily: T.body, fontSize: 17, lineHeight: 1.65, 
                  fontWeight: 600, color: T.ink, margin: '0 0 14px' 
                }}>
                  "The best interface is the one the user never has to think about."
                </p>
                <span style={{ 
                  fontFamily: T.mono, fontSize: 10, fontWeight: 700, 
                  letterSpacing: '0.2em', textTransform: 'uppercase', color: T.blue 
                }}>
                  {'// Design mantra'}
                </span>
              </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(236px, 1fr))', gap: 16 }}>
            {skillsData.map((skill) => (
              ...
              >
                ...
                <div style={{
                  width: 46, height: 46, background: T.blue, 
                  color: '#fff',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: 20, marginBottom: 18, borderRadius: '50%',
                }}>
                  {skill.icon}
                </div>
                <h3 style={{ fontFamily: T.body, fontSize: 16, fontWeight: 700, margin: '0 0 10px', color: T.ink }}>
                  {skill.title}
                </h3>
                <p style={{ fontFamily: T.body, fontSize: 13, lineHeight: 1.7, color: T.muted, margin: 0 }}>
                  {skill.desc}
                </p>
              </motion.div>
            ))}
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {experienceData.map((exp) => (
              ...
              >
                ...
                <div>
                  <h3 style={{ 
                    fontFamily: T.body, fontSize: 26, fontWeight: 800, 
                    margin: '0 0 6px', letterSpacing: '-0.5px', color: T.ink 
                  }}>
                    {exp.position}
                  </h3>
                  <p style={{ 
                  ...
                  <p style={{ 
                    fontFamily: T.body, fontSize: 16, lineHeight: 1.75, 
                    color: '#444', marginBottom: exp.technologies.length ? 20 : 0 
                  }}>
                    {exp.description}
                  </p>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 64 }}>
            {educationData.map((edu) => (
              ...
              >
                ...
                <h3 style={{ 
                  fontFamily: T.body, fontSize: 21, fontWeight: 800, 
                  margin: '0 0 10px', lineHeight: 1.3, color: T.ink 
                }}>
                  {edu.degree}
                </h3>
                <p style={{ 
                ...
                <p style={{ 
                  ...
                  color: T.blue, letterSpacing: '0.12em', marginBottom: 18 
                }}>
                  {edu.period}
                </p>
                <p style={{ 
          ...
          <motion.div variants={fadeUp}>
            <p style={{ 
              ...
              color: T.ink, marginBottom: 24, borderLeft: `3px solid ${T.blue}`, 
              paddingLeft: 12 
            }}>
              {'> Certifications & Licences'}
            </p>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(218px, 1fr))', gap: 16 }}>
              {certificateData.map((cert) => (
                ...
                >
                  ...
                  <div style={{ 
                    ...
                    background: T.blue, 
                    color: '#fff', display: 'flex', alignItems: 'center', 
                    justifyContent: 'center', fontSize: 18, borderRadius: '50%',
                  }}>
                    {cert.icon}
                  </div>
                  <div>
                    <p style={{ 
                      ...
                      margin: '0 0 4px', lineHeight: 1.3, color: T.ink 
                    }}>
                      {cert.title}
                    </p>
                    <p style={{ fontFamily: T.mono, fontSize: 11, color: T.blue, margin: '0 0 4px' }}>
                      {cert.issuer}
                    </p>
                    <p style={{ 
                      fontFamily: T.mono, fontSize: 10, fontWeight: 700, 
                      color: T.blue, letterSpacing: '0.1em', margin: 0 
                    }}>
                      {cert.date}
                    </p>
                  </div>
          ...
          <motion.div variants={fadeUp} style={{ marginTop: 64 }}>
            <p style={{ 
              fontFamily: T.mono, fontSize: 10, fontWeight: 700, 
              letterSpacing: '0.3em', textTransform: 'uppercase', 
              color: T.ink, marginBottom: 20, borderLeft: `3px solid ${T.blue}`, 
              paddingLeft: 12 
            }}>
              {'> Interests & Passions'}
            </p>
              ...
              {interests.map((tag) => (
                <motion.span
                  ...
                  style={{
                    ...
                    background: T.white,
                    fontFamily: T.mono, fontSize: 12, fontWeight: 600,
                    color: T.ink, transition: 'all 0.3s ease',
                  }}
                >
                  {tag}
                </motion.span>
      ...
      >
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '88px 56px 0', position: 'relative', zIndex: 1 }}>
