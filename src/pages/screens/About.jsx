  ...
  return (
    <div className={`about-container ${darkMode ? "dark-theme" : ""}`}>
      ...
      >
        <div className="profile-content">
          ...
          >
            <div className="profile-image">
              <img src={oscar} alt="Oscar Kyle Poco" className="avatar-image" />
            </div>
            <motion.h1
          ...
          <motion.div className="profile-info" variants={itemVariants}>
            ...
            <p className="profile-description">
              Passionate developer with a knack for creating elegant, responsive
              and user-friendly <b>WEB</b> & <b>MOBILE</b> applications.
              Specialized in JavaScript ecosystem as a Mobile Developer with 3+
              years of professional experience building scalable solutions for
              various industries.
            </p>
        ...
        <motion.div className="qrcode" variants={itemVariants}>
          ...
          {portfolioStats.map((stat, index) => (
            ...
            >
              ...
              <div className="folder-count">
                ...
                {stat.subtitle && (
                  <span className="count-subtitle">{stat.subtitle}</span>
                )}
              </div>
